...
TEST(Instruction, Store) {
  ...
  jasmin::ExecuteInstruction<jasmin::Store>(value_stack, &n8, sizeof(int8_t));
  value_stack.push(int16_t{16});
  jasmin::ExecuteInstruction<jasmin::Store>(value_stack, &n16, sizeof(int16_t));
  value_stack.push(int32_t{32});
  jasmin::ExecuteInstruction<jasmin::Store>(value_stack, &n32, sizeof(int32_t));
  value_stack.push(int64_t{64});
  jasmin::ExecuteInstruction<jasmin::Store>(value_stack, &n64, sizeof(int64_t));
